...
const Sidebar = () => {
  ...
  return (
    <>
      <div className={`${sidebar.sidebar_nav} my-3 container`}>
        <div>
          <img src={LogoDark} className="img-fluid w-50" />
        </div>
        {open ? (
          <MdMenu className={`${sidebar.toggle_btn}`} onClick={handleToggle} />
        ) : (
          <MdClose className={`${sidebar.toggle_btn}`} onClick={handleToggle} />
        )}
      ...
      >
        ...
        <ul className={`${sidebar.list_container}`}>
          ...
          <li className={`${sidebar.sidebar_list}`}>
            <img src={Vector1} className="me-2 d-inline-block" />
          ...
          <li className={`${sidebar.sidebar_list}`}>
            <img src={Vector2} className="me-2 d-inline-block" />
          ...
          <li className={`${sidebar.sidebar_list}`}>
            {/* <img src={Vector} className="me-2 d-inline-block" /> */}
            <IoMdNotifications size="2rem" className="me-2 d-inline-block" />
          ...
          <li className={`${sidebar.sidebar_list}`}>
            {/* <img src={Vector} className="me-2 d-inline-block" /> */}
            <BiLogOut size="2rem" className="me-2 d-inline-block" />
